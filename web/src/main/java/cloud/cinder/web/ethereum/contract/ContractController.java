package cloud.cinder.web.ethereum.contract;
...
import cloud.cinder.web.ethereum.contract.command.AccessContractCommand;
import cloud.cinder.web.ethereum.contract.command.GenerateUICommand;
